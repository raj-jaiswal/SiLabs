#!/usr/bin/env python3
"""
create_dual_nn_notebook.py
Programmatically constructs `train_dual_input_neural_network.ipynb` using nbformat.
Trains 3 End-to-End Dual-Input Neural Networks (Hypotension, Hypoxia, Tachycardia)
...
def create_notebook():
    ...
    cells.append(nbf.v4.new_markdown_cell(
        ...
        "\n"
        "This notebook trains **3 Dual-Input End-to-End Neural Networks** (`Dual-NN Hypotension`, `Dual-NN Hypoxia`, `Dual-NN Tachycardia`) "
        "that fuse 1D CNN time-series telemetry (600 seconds $\\times$ 19 vital features) with patient clinical metadata (65 features).\n"
        "\n"
    ...
    # Cell 2: Dual-Input Model Architecture Builder
    cells.append(nbf.v4.new_markdown_cell("## 2. Dual-Input Model Architecture Builder"))
    cell2_code = (
    ...
    output_nb_path = "train_dual_input_neural_network.ipynb"
    with open(output_nb_path, "w", encoding="utf-8") as f:
        nbf.write(nb, f)
        
    print(f"Successfully generated dual-NN notebook: {output_nb_path}")
