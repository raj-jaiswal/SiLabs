...
export function generateDemographics(patientId: string): PatientDemographics {
  if (patientId === 'PATIENT-000' || patientId.includes('000')) {
    return {
      ...
      heightCm: 165,
      bmi: 25.0,
      primaryDiagnosis: 'Acute Intraoperative Monitoring (ESP32 AI Telemetry)',
      comorbidities: ['Hypertension', 'Real-Time Wi-Fi Edge Ingestion'],
      allergies: ['Penicillin', 'Latex'],
      attendingPhysician: 'Dr. Elena Rostova, MD (Anesthesiology)',
      isEsp32Live: true,
    };
  }
