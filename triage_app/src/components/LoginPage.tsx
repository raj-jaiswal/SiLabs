    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-slate-900 font-sans select-none">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-xl p-8 shadow-sm space-y-6">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-3.5 space-y-2">
          <div className="text-[11px] font-mono font-bold text-slate-600 uppercase tracking-wider text-center">
            Quick Demo Logins (1-Click)
          </div>
          <div className="grid grid-cols-2 gap-2 text-xs font-mono">
            <button
              onClick={() => handleQuickLogin('admin@hospital.com', 'admin')}
              className="px-2.5 py-1.5 bg-red-50 hover:bg-red-100 border border-red-200 text-red-800 rounded font-semibold transition-colors flex items-center justify-center space-x-1"
            >
            ...
            <button
              ...
              className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 rounded font-semibold transition-colors flex items-center justify-center space-x-1"
            >
