            ...
            <div className="flex items-center space-x-2">
              <div className="flex items-center space-x-2 bg-slate-50 border border-slate-300 rounded-lg px-2.5 py-1.5 text-xs">
                ...
                <span className={`text-[10px] font-mono px-1.5 py-0.2 rounded font-bold border ${
                  currentUser.role === 'ADMIN' ? 'bg-red-50 text-red-700 border-red-300' : 'bg-slate-200 text-slate-800 border-slate-300'
                }`}>
                  {currentUser.role}
                </span>
              </div>
              ...
              <button
                onClick={logout}
                title="Sign out"
                className="p-1.5 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 hover:text-red-600 rounded-lg transition-colors"
              >
